...
var FS = /** @class */ (function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.exists(targetPath)];
                                case 1:
                                    exists = _a.sent();
                                    if (!(!exists && targetPath)) return [3 /*break*/, 3];
                                    return [4 /*yield*/, this.createFolder(targetPath)];
                                case 2:
                                    _a.sent();
                                    _a.label = 3;
                                case 3:
    ...
    FS.prototype.deleteFile = function (source) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exists(source)];
                    case 1:
                        exists = _a.sent();
                        if (exists)
                            return [2 /*return*/, new Promise(function (resolve, reject) {
    ...
    FS.prototype.createFile = function (path, content) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.deleteFile(path)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.writeFile(path, content || '')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FS.prototype._copyFilesToFolder = function (source, target) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exists(target)];
                    case 1:
                        exists = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this._isDirectory(target)];
                                        case 1:
                                            isDir = _a.sent();
                                            if (isDir)
    ...
    FS.prototype.copyFolder = function (source, target) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            Promise.resolve().then(function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fns_1.forEach(files, function (file) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var curSource, isDirectory;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            curSource = path.join(source, file);
                                            return [4 /*yield*/, this._isDirectory(curSource)];
                                        case 1:
                                            isDirectory = _a.sent();
                                            if (!isDirectory) return [3 /*break*/, 3];
                                            return [4 /*yield*/, this.copyFolder(curSource, targetFolder)];
                                        case 2:
                                            _a.sent();
                                            return [3 /*break*/, 5];
                                        case 3: return [4 /*yield*/, this._copyFilesToFolder(curSource, targetFolder)];
                                        case 4:
                                            _a.sent();
                                            _a.label = 5;
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, fns_1.forEach(files, function (file) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                var isDir, fullPath, content, splitted, ext, nameNoExt;
                                                return tslib_1.__generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, this._isDirectory(path + '/' + file)];
                                                        case 1:
                                                            isDir = _a.sent();
                                                            if (!isDir) return [3 /*break*/, 4];
                                                            if (!deep) return [3 /*break*/, 3];
                                                            return [4 /*yield*/, this._read(path + '/' + file, res)];
                                                        case 2:
                                                            _a.sent();
                                                            _a.label = 3;
                                                        ...
                                                        case 4:
                                                            ...
                                                            if (path.indexOf('/') == 0)
                                                                fullPath = '/' + fullPath;
                                                            return [4 /*yield*/, this.readFile(fullPath, contentType)];
                                                        case 5:
                                                            content = _a.sent();
                                                            splitted = file.split('.');
                                                            ext = '', nameNoExt = file;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        res = [];
                        return [4 /*yield*/, this._read(path, res, contentType, deep)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res];
                }
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, fns_1.filter(files, function (file) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                var isDir;
                                                return tslib_1.__generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, this._isDirectory(path.join(srcpath, file))];
                                                        case 1:
                                                            isDir = _a.sent();
                                                            return [2 /*return*/, isDir];
                                                    }
                                                });
                                            }); })];
                                    case 1:
                                                ...
                                                return [4 /*yield*/, fns_1.forEach(files, function (file) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                        ...
                                                        return tslib_1.__generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                    curPath = path + "/" + file;
                                                                    return [4 /*yield*/, this._isDirectory(curPath)];
                                                                case 1:
                                                                    isDir = _a.sent();
                                                                    if (!isDir) return [3 /*break*/, 3];
                                                                    return [4 /*yield*/, this.deleteFolder(curPath)];
                                                                case 2:
                                                                    _a.sent();
                                                                    return [3 /*break*/, 5];
                                                                case 3: // delete file
                                                                return [4 /*yield*/, fs.unlinkSync(curPath)];
                                                                case 4:
                                                                    _a.sent();
                                                                    _a.label = 5;
                                                                case 5: return [2 /*return*/];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, fns_1.forEach(path.split('/'), function (fldr) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var exists;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!fldr)
                                                return [2 /*return*/];
                                            pathSeq += fldr;
                                            return [4 /*yield*/, this.exists(pathSeq)];
                                        case 1:
                                            exists = _a.sent();
                                            if (!!exists) return [3 /*break*/, 3];
                                            return [4 /*yield*/, fs.mkdir(pathSeq)];
                                        case 2:
                                            _a.sent();
                                            _a.label = 3;
                                        case 3:
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fail = Symbol();
                    return [4 /*yield*/, Promise.all(arr.map(function (item) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, callback(item)];
...
var DataSourceHelper = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, fs_1.default.readFile(path)];
    ...
    DataSourceHelper.prototype.saveModel = function (path, model) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.writeFile(path, JSON.stringify(model, null, 4))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, fs_1.default.readFile("workspace/" + projectName + "/meta.json")];
                    case 1:
                        meta = _b.apply(_a, [_c.sent()]);
                        meta.idSeq++;
                        return [4 /*yield*/, fs_1.default.writeFile("workspace/" + projectName + "/meta.json", JSON.stringify(meta))];
                    case 2:
                        _c.sent();
                        return [2 /*return*/, meta.idSeq];
                }
            });
        });
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var expressApp_1 = __webpack_require__(8);
...
var fs_1 = __webpack_require__(1);
var fns_1 = __webpack_require__(2);
var hbsSettings_1 = __webpack_require__(9);
var all_1 = __webpack_require__(10);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = req.body;
                        return [4 /*yield*/, fs_1.default.readFile(pathToUploadedFile, true)];
                    case 1:
                        file = _a.sent();
                        return [4 /*yield*/, fs_1.default.deleteFile(pathToUploadedFile)];
                    case 2:
                        _a.sent();
                        params.file = file;
...
var HbsSettings = /** @class */ (function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var fileSystemController_1 = __webpack_require__(11);
var indexController_1 = __webpack_require__(12);
var projectController_1 = __webpack_require__(13);
var resourceController_1 = __webpack_require__(17);
exports.all = [
...
var fs_1 = __webpack_require__(1);
var FileSystemController = /** @class */ (function () {
    ...
    FileSystemController.prototype.renameFolder = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.rename(params.oldName, params.newName)];
                    case 1:
                        _a.sent();
    ...
    FileSystemController.prototype.deleteFolder = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.deleteFolder(params.name)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { success: true }];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.default.writeFile("workspace/" + params.projectName + "/" + params.path, params.content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, {}];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!params.projectName)
                            throw 'project name not specified';
                        return [4 /*yield*/, fs_1.default.deleteFile("workspace/" + params.projectName + "/" + params.path)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { success: true }];
                }
    ...
    FileSystemController.prototype.uploadFile = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.writeFile("workspace/" + params.projectName + "/" + params.path, params.file, true)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { success: true }];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!params.projectName)
                            throw 'project name not specified';
                        return [4 /*yield*/, fs_1.default.readFile("workspace/" + params.projectName + "/" + params.path)];
...
var decorators_1 = __webpack_require__(3);
var fs_1 = __webpack_require__(1);
var projectService_1 = __webpack_require__(14);
var ProjectController = /** @class */ (function () {
    ...
    ProjectController.prototype.getAll = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.getDirList('./workspace')];
                    case 1:
                        list = _a.sent();
                        return [2 /*return*/, list.map(function (it) { return ({ name: it }); })];
                }
            });
        });
    };
    ProjectController.prototype.create = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, projectService_1.projectService.createProject(params.projectName)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ProjectController.prototype.exist = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, projectService_1.projectService.exist(params.projectName)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var codeTemplates_1 = __webpack_require__(15);
var consts_1 = __webpack_require__(16);
var ProjectService = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.default.createFolder("workspace/" + projectName + "/resources")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.createFolder("workspace/" + projectName + "/scripts/custom")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + projectName + "/scripts/custom/appLib.js", codeTemplates_1.getLibCodeScript('AppLib'))];
                    case 3:
                        _a.sent();
                        mainSceneScript = codeTemplates_1.getDefaultCodeScript(mainSceneName[0].toUpperCase() + mainSceneName.substr(1));
                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + projectName + "/scripts/" + mainSceneName + ".js", mainSceneScript)];
                    case 4:
                        _a.sent();
    ...
    ProjectService.prototype.exist = function (projectName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.exists("workspace/" + projectName)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var decorators_1 = __webpack_require__(3);
var fs_1 = __webpack_require__(1);
var resourceService_1 = __webpack_require__(18);
var generatorService_1 = __webpack_require__(19);
var dataSourceHelper_1 = __webpack_require__(5);
var ResourceController = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        result = {};
                        return [4 /*yield*/, fs_1.default.readFile("workspace/" + params.projectName + "/repository.json")];
                    case 1:
                        repository = _c.sent();
                        return [4 /*yield*/, fs_1.default.readFile("workspace/" + params.projectName + "/gameProps.json")];
                    case 2:
                        gameProps = _c.sent();
                        result.repository = JSON.parse(repository);
                        result.gameProps = JSON.parse(gameProps);
                        _a = result;
                        return [4 /*yield*/, resourceService_1.resourceService.getCommonBehaviourAttrs(params.projectName)];
                    case 3:
                        _a.commonBehaviourProtos = _c.sent();
                        _b = result;
                        return [4 /*yield*/, fs_1.default.readDir("workspace/" + params.projectName + "/scripts/custom/")];
                    case 4:
    ...
    ResourceController.prototype.save = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.loadModel("workspace/" + params.projectName + "/repository.json")];
                    case 1:
                        repository = _a.sent();
                        model = params.model;
                        ...
                        return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.uuid(params.projectName)];
                    case 2:
                        createdId = _a.sent();
                        model.id = createdId;
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.saveModel("workspace/" + params.projectName + "/repository.json", repository)];
                    case 5:
                        _a.sent();
                        if (createdId)
                            return [2 /*return*/, { created: true, id: createdId }];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.loadModel(path)];
                    case 1:
                        model = _a.sent();
                        Object.keys(params.model).forEach(function (key) {
                            model[key] = params.model[key];
                        });
                        return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.saveModel(path, model)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ResourceController.prototype.generate = function (params, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, generatorService_1.generatorService.generate(params, response)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dataSourceHelper_1.dataSourceHelper.loadModel('client-app/engine/commonBehaviour/impl/desc/desc.json')];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var fs_1 = __webpack_require__(1);
var webpack_config_1 = __webpack_require__(24);
var termToHtml_1 = __webpack_require__(25);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.default.readFile('./node-app/generator/error.html')];
                    case 1:
                        content = (_a.sent());
                        content = content.replace('${error}', termToHtml_1.termToHtml(error));
                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + params.projectName + "/out/index.html", content)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.default.createFolder("workspace/" + params.projectName + "/out/")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.createFolder("workspace/" + params.projectName + "/generated/src/engine")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.createFolder("workspace/" + params.projectName + "/generated/src/app")];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.default.copyFolder("client-app/engine", "workspace/" + params.projectName + "/generated/src/")];
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, fs_1.default.copyFolder("workspace/" + params.projectName + "/scripts", "workspace/" + params.projectName + "/generated/src/app/")];
                    case 2:
                        _e.sent();
                        return [4 /*yield*/, fs_1.default.readDir("workspace/" + params.projectName + "/scripts", undefined, false)];
                    case 3:
                        ...
                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + params.projectName + "/generated/src/app/scripts/allScripts.js", allScriptCode)];
                    case 4:
                        _e.sent();
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, fs_1.default.readFile("./workspace/" + params.projectName + "/repository.json")];
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, fs_1.default.createFile("./workspace/" + params.projectName + "/generated/src/app/repository.ts", "export let repository:any = \n\t" + JSON.stringify(repository, null, 4) + ";")];
                    case 7:
                        _e.sent();
                        return [4 /*yield*/, fs_1.default.createFile("./workspace/" + params.projectName + "/generated/src/app/gameProps.ts", "export let gameProps:any = \n\t" + JSON.stringify(gameProps, null, 4) + ";")];
                    case 8:
                        _e.sent();
                        return [4 /*yield*/, fs_1.default.copyFile('node-app/generator/index.tpl', "workspace/" + params.projectName + "/generated/src/index.ts")];
                    case 9:
                        _e.sent();
                        embeddedResources = {};
                        if (!!params.embedResources) return [3 /*break*/, 11];
                        return [4 /*yield*/, fs_1.default.copyFolder("workspace/" + params.projectName + "/resources/", "workspace/" + params.projectName + "/out/")];
                    case 10:
                        _e.sent();
                        return [3 /*break*/, 13];
                    case 11: return [4 /*yield*/, fs_1.default.readDir("workspace/" + params.projectName + "/resources", 'binary')];
                    case 12:
                        ...
                        _e.label = 13;
                    case 13: return [4 /*yield*/, fs_1.default.createFile("./workspace/" + params.projectName + "/generated/src/app/embeddedResources.ts", "export let embeddedResources:any = \n\t" + JSON.stringify(embeddedResources, null, 4) + ";")];
                    case 14:
                        _e.sent();
                        return [2 /*return*/];
                }
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, GeneratorService._createError(params, err)];
                                    case 1:
                                        _a.sent();
                                        ...
                                        return [3 /*break*/, 11];
                                    case 2:
                                        if (!(data.compilation && data.compilation.errors && data.compilation.errors[0])) return [3 /*break*/, 4];
                                        ...
                                        return [4 /*yield*/, GeneratorService._createError(params, errorMsg)];
                                    case 3:
                                        _a.sent();
                                        response.write("error<br>");
                                        response.end();
                                    ...
                                    case 4:
                                        ...
                                        return [4 /*yield*/, fs_1.default.readFile('./node-app/generator/index.html')];
                                    case 5:
                                        indexHtml = _a.sent();
                                        debugJs = '';
                                        if (!params.debug) return [3 /*break*/, 7];
                                        return [4 /*yield*/, fs_1.default.readFile("./workspace/" + params.projectName + "/generated/tmp/debug.js")];
                                    case 6:
                                        debugJs = (_a.sent());
                                        _a.label = 7;
                                    case 7:
                                        ...
                                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + params.projectName + "/out/index.html", indexHtml)];
                                    case 8:
                                        _a.sent();
                                        console.log('creating bundle');
                                        return [4 /*yield*/, fs_1.default.readFile("./workspace/" + params.projectName + "/generated/tmp/bundle.js")];
                                    case 9:
                                        appBundleJs = _a.sent();
                                        return [4 /*yield*/, fs_1.default.createFile("workspace/" + params.projectName + "/out/bundle.js", appBundleJs)];
                                    case 10:
                                        _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 7]);
                        return [4 /*yield*/, this.createFolders(params)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.generateData(params)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.compile(params, response)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5:
                        ...
                        return [4 /*yield*/, GeneratorService._createError(params, e_1.toString())];
                    case 6:
                        _a.sent();
                        response.write("error<br>");
                        response.end();
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(20).Buffer, __webpack_require__(4)))
...
"use strict";
// https://gist.github.com/walling/7543151
