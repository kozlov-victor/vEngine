...
var Camera = function () {
    ...
    Camera.prototype.update = function update() {
        ...
        var pos = this.pos;
        var tileWidth = 55; //this.scene.tileMap.spriteSheet?this.scene.tileMap.spriteSheet._frameWidth:0;
        var tileHeight = 55; //this.scene.tileMap.spriteSheet? this.scene.tileMap.spriteSheet._frameHeight:0;
