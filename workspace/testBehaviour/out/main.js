...
modules['behaviour'] = {code: function(module,exports){
	...
	scripts.gameObject['center.js'] = function(exports,self){
	...
	scripts.gameObject['tc.js'] = function(exports,self){
...
modules['bundle'] = {code: function(module,exports){
	...
	var Bundle = function(data){
	    ...
	    var applyCommonBehaviour = function(model){
	        ...
	        var exportsList = [];
	        console.log('model._commonBehaviour',model.name,model._commonBehaviour);
	...
	data = {
	    ...
	    spriteSheet:[
	    {
	        "_frameWidth": 0,
	        "_frameHeight": 0,
	        "resourcePath": "resources/spriteSheet/tc.png",
	        "width": 156,
	        "height": 156,
	        "name": "tc",
	        "type": "spriteSheet",
	    ...
	    },
	    {
	        "_frameWidth": 0,
	        "_frameHeight": 0,
	        "resourcePath": "resources/spriteSheet/center.png",
	        "width": 64,
	        "height": 64,
	        "name": "center",
	        "type": "spriteSheet",
