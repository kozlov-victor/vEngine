(function(t) {
    ...
    e.isRectIntersectRect = function(t, e) {
        var r = n(t.x, e.x, e.x + e.width), i = n(e.x, t.x, t.x + t.width), o = n(t.y, e.y, e.y + e.height), a = n(e.y, t.y, t.y + t.height);
        var s = r || i;
        var u = o || a;
        return s && u;
    };
    ...
    var i = {};
    i.linear = function(t, e, r, n) {
        return r * t / n + e;
    };
    i.easeInQuad = function(t, e, r, n) {
        t /= n;
        return r * t * t + e;
    };
    i.easeOutQuad = function(t, e, r, n) {
        t /= n;
        return -r * t * (t - 2) + e;
    };
    i.easeInOutQuad = function(t, e, r, n) {
        t /= n / 2;
    ...
    var c = (i = n = function() {
        ...
        t.prototype.update = function t() {
            ...
            Object.keys(this.buffer).forEach(function(t) {
                if (e.buffer[t] === s) e.buffer[t] = a; else if (e.buffer[t] === f) e.buffer[t] = u;
            });
        };
    ...
    e.matrixMultiply = function(t, e) {
        ...
        var A = e[3 * 4 + 2];
        var P = e[3 * 4 + 3];
        return [ r * g + n * x + i * R + o * S, r * _ + n * E + i * j + o * B, r * b + n * T + i * F + o * A, r * w + n * O + i * M + o * P, a * g + s * x + u * R + f * S, a * _ + s * E + u * j + f * B, a * b + s * T + u * F + f * A, a * w + s * O + u * M + f * P, c * g + l * x + h * R + p * S, c * _ + l * E + h * j + p * B, c * b + l * T + h * F + p * A, c * w + l * O + h * M + p * P, d * g + m * x + v * R + y * S, d * _ + m * E + v * j + y * B, d * b + m * T + v * F + y * A, d * w + m * O + v * M + y * P ];
    };
}, function(t, e, r) {
    "use strict";
    e.__esModule = true;
    ...
    var o = function() {
        ...
        t.prototype.move = function t(e, r, n) {
            ...
            for (var o = 0, a = i.length; o < a; o++) {
                ...
                var u = i[o].getRect();
                if (e !== i[o] && this.overlapTest(s, u)) {
                    if (r < 0) r = u.x + u.width - e.pos.x; else if (r > 0) r = u.x - e.pos.x - e.width;
                }
            }
            e.pos.x += r;
            for (var f = 0, c = i.length; f < c; f++) {
                ...
                var h = i[f].getRect();
                if (e !== i[f] && this.overlapTest(l, h)) {
                    if (n < 0) n = h.y + h.height - e.pos.y; else if (n > 0) n = h.y - e.pos.y - e.height;
                }
            }
            e.pos.y += n;
        };
    ...
    var f = function() {
        ...
        t.prototype.update = function t(e, r) {
            ...
            this.game._collider.move(this.gameObject, n, i);
            this.gameObject.rigidBody.onFloor = o > this.gameObject.pos.y;
            if (o !== this.gameObject.pos.y) this.gameObject.rigidBody.vel.y = 0;
        };
        return t;
    }();
    e.default = f;
