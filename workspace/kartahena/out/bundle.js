...
var rect_1 = __webpack_require__(1);
var debugError_1 = __webpack_require__(0);
var scrollableContainer_1 = __webpack_require__(80);
var TEXT_ALIGN;
(function (TEXT_ALIGN) {
...
var Tween = function () {
    ...
    Tween.prototype.update = function (time) {
        ...
        while (l--) {
            ...
            var fn = mathEx[this.easeFnName];
            var valCurr = fn(curTweenTime, valFrom, valTo - valFrom, this.tweenTime);
...
var vscroll_1 = __webpack_require__(81);
...
Object.defineProperty(exports, "__esModule", { value: true });
var webAudioContext_1 = __webpack_require__(104);
var htmlAudioContext_1 = __webpack_require__(106);
var fakeAudioContext_1 = __webpack_require__(107);
var audioNodeSet_1 = __webpack_require__(108);
var tween_1 = __webpack_require__(22);
var debugError_1 = __webpack_require__(0);
...
var gameProps_1 = __webpack_require__(118);
var repository_1 = __webpack_require__(119);
...
var Game = function (_super) {
    ...
    Game.prototype.runScene = function (scene) {
        ...
        if (true) {
            var allScripts_1 = __webpack_require__(110);
...
Object.defineProperty(exports, "__esModule", { value: true });
var abstractRenderer_1 = __webpack_require__(79);
var consts_1 = __webpack_require__(45);
var rect_1 = __webpack_require__(1);
...
var ScrollInfo = function () {
    ...
    ScrollInfo.prototype.update = function (time, delta) {
        ...
        if (mathEx_1.closeTo(this._scrollVelocity, 0, 3)) {
            this._scrollVelocity = 0;
            this._deceleration = 0;
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var frameAnimation_1 = __webpack_require__(91);
...
var particleSystem_1 = __webpack_require__(94);
exports.ParticleSystem = particleSystem_1.ParticleSystem;
var scene_1 = __webpack_require__(95);
exports.Scene = scene_1.Scene;
var sound_1 = __webpack_require__(98);
exports.Sound = sound_1.Sound;
var font_1 = __webpack_require__(99);
...
Object.defineProperty(exports, "__esModule", { value: true });
var debugError_1 = __webpack_require__(0);
var loaderUtil_1 = __webpack_require__(105);
var audioPlayer_1 = __webpack_require__(50);
...
Object.defineProperty(exports, "__esModule", { value: true });
var audioNode_1 = __webpack_require__(109);
...
var _boardCardSheet = __webpack_require__(111);
...
var _descScene = __webpack_require__(114);

Object.defineProperty(exports, 'DescSceneBehaviour', {
  enumerable: true,
  get: function get() {
    return _descScene.DescSceneBehaviour;
  }
});

var _introScene = __webpack_require__(115);
...
var _setFieldScene = __webpack_require__(116);

Object.defineProperty(exports, 'SetFieldSceneBehaviour', {
  enumerable: true,
  get: function get() {
    return _setFieldScene.SetFieldSceneBehaviour;
  }
});
...
var DescSceneBehaviour = exports.DescSceneBehaviour = function () {
    function DescSceneBehaviour() {
        _classCallCheck(this, DescSceneBehaviour);
    }

    _createClass(DescSceneBehaviour, [{
        key: 'onCreate',
        value: function onCreate() {
            var self = this;
...
exports.SetFieldSceneBehaviour = undefined;
...
var Board = function () {
    function Board(game, cards) {
        ...
        for (var j = 0; j < 2; j++) {
            ...
            for (var i = 0; i < 2; i++) {
                var cell = {};
                var r = new _rectangle.Rectangle(this.game);
                r.fillColor = new _color.Color(0, 0, 100, 100);
                r.width = 200;
                r.height = 200;
                r.pos.x = i * 200;
                r.pos.y = j * 200;
    ...
    _createClass(Board, [{
        ...
        value: function setUp() {
            ...
            this.cards.forEach(function (it, i) {
                it.setFrameIndex(i);
                it.revalidate();
                var selectedColor = new _color.Color();
                selectedColor.setRGBA(20, 255, 0, 50);
                var defaultColor = new _color.Color();
                defaultColor.setRGBA(0, 255, 0, 0);
                it.filters.push(new _colorizeFilter.ColorizeFilter(_this.game.renderer.gl));
...
var SetFieldSceneBehaviour = exports.SetFieldSceneBehaviour = function () {
    function SetFieldSceneBehaviour() {
        _classCallCheck(this, SetFieldSceneBehaviour);
    }

    _createClass(SetFieldSceneBehaviour, [{
        key: 'onCreate',
        value: function onCreate() {
