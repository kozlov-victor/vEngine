...
var observableEntity_1 = __webpack_require__(43);
    ...
    if (size === 1) {
        switch (type) {
            ...
            case 'mat3': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeNumber, 3 * 3));
                gl.uniformMatrix3fv(location, false, value);
            };
            case 'mat4': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeNumber, 4 * 4));
        ...
        switch (type) { // ie uniform vec2 u_someVec2[3]
            case 'float': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeNumber));
            ...
            case 'int': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeInt));
            ...
            case 'bool': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeBool));
                gl.uniform1iv(location, value);
            };
            case 'bvec2': return function (gl, location, value) {
                false && expect(value, TypeArray(TypeBool));
...
var tween_1 = __webpack_require__(37);
var eventEmitter_1 = __webpack_require__(81);
...
var BaseModel = /** @class */ (function (_super) {
    ...
    function BaseModel(game) {
        ...
        _this.rotatePivot = new point2d_1.Point2d(0, 0); // todo show in interface
        _this.angle = 0;
        _this.alpha = 1;
        _this.layerId = null;
...
var tslib_1 = __webpack_require__(0);
var shaderProgramUtils_1 = __webpack_require__(4);
var shaderGenerator_1 = __webpack_require__(45);
...
Object.defineProperty(exports, "__esModule", { value: true });
var vertexBuffer_1 = __webpack_require__(97);
...
var CommonObject = /** @class */ (function () {
    ...
    CommonObject.prototype.toJSON = function (opts) {
        ...
        var _loop_1 = function (key) {
            ...
            if (this_1[key] != null && this_1[key]['type'] && this_1[key]['id']) { // is model
                res[key] = {
                    id: this_1[key]['id'],
                    type: this_1[key]['type']
                };
            }
            else if (this_1[key] != null && this_1[key]['splice']) { // is arr
                var col = this_1[key];
                var arr_1 = [];
...
var renderableModel_1 = __webpack_require__(38);
var OVERFLOW;
(function (OVERFLOW) {
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.describeStates = function (description) {
        var _this = this;
        var allUIRenderable = __webpack_require__(36);
...
var bufferInfo_1 = __webpack_require__(12);
var texShaderGenerator_1 = __webpack_require__(11);
...
var RigidCircle = /** @class */ (function (_super) {
    ...
    function RigidCircle(center, radius, mass, friction, restitution) {
        var _this = _super.call(this, center, mass, friction, restitution) || this;
        _this.mType = "Circle";
...
var RigidRectangle = /** @class */ (function (_super) {
    ...
    function RigidRectangle(center, width, height, mass, friction, restitution) {
        var _this = _super.call(this, center, mass, friction, restitution) || this;
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var abstractPrimitive_1 = __webpack_require__(23);
...
var tween_1 = __webpack_require__(37);
var mat4 = __webpack_require__(9);
var mathEx = __webpack_require__(6);
var rect_1 = __webpack_require__(1);
var point2d_1 = __webpack_require__(3);
        ...
        for (var j = 0; j < mapHeight; j++) {
            ...
            for (var i = 0; i < mapWidth; i++) {
                ...
                if (val === 0)
                    ...
                    var r = new rigidShapes_1.RigidRectangle(c, w, h, 0);
                    r.fixedAngle = true;
...
var GameObjectProto = /** @class */ (function (_super) {
    ...
    GameObjectProto.prototype.revalidate = function () {
        ...
        if (this.rigid) {
            var center = new rigidShapes_1.Vec2(this.pos.x + this.width / 2, this.pos.y + this.height / 2);
            var mass = this.name == 'platform' ? 0 : 10; // todo
            this.rigidBody = new rigidShapes_1.RigidRectangle(center, this.width, this.height, mass);
        }
        if (false) {}
    };
...
var tslib_1 = __webpack_require__(0);
var container_1 = __webpack_require__(16);
var textField_1 = __webpack_require__(17);
...
var rectangle_1 = __webpack_require__(80);
exports.Rectangle = rectangle_1.Rectangle;
var ninePatchImage_1 = __webpack_require__(79);
exports.NinePatchImage = ninePatchImage_1.NinePatchImage;
var absoluteLayout_1 = __webpack_require__(33);
...
var RenderableModel = /** @class */ (function (_super) {
    ...
    RenderableModel.prototype.render = function () {
        ...
        if (!(this.angle === 0 && this.scale.equal(1))) {
            var pivX = this.rotatePivot.x;
            var pivY = this.rotatePivot.y;
...
var Mouse = /** @class */ (function () {
    ...
    Mouse.prototype.triggerPossibleChildren = function (c, eventName, point, offsetX, offsetY) {
        for (var i = 0; i < c.length; i++) {
            var go = c[c.length - 1 - i];
            var isCaptured = Mouse.triggerGameObjectEvent(eventName, point, go, offsetX, offsetY);
            if (isCaptured) {
                if (go.children)
                    this.triggerPossibleChildren(go.children, eventName, point, offsetX + go.pos.x, offsetY + go.pos.y);
                break;
            }
        }
    };
    Mouse.prototype.triggerEvent = function (e, eventName, isMouseDown) {
        ...
        for (var _i = 0, _a = scene.getAllGameObjects(); _i < _a.length; _i++) {
            ...
            if (isCaptured) {
                if (go.children)
                    this.triggerPossibleChildren(go.children, eventName, point, go.pos.x, go.pos.y);
                break;
            }
        }
        var untransformedPoint = MousePoint.unTransform(point);
        for (var j = 0; j < scene.uiLayer.gameObjects.length; j++) {
            ...
            if (isCaptured) {
                if (go.children)
                    this.triggerPossibleChildren(go.children, eventName, untransformedPoint, go.pos.x, go.pos.y);
                break;
            }
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var pointLight_1 = __webpack_require__(95);
...
exports.gameProps = {
    ...
    "gravityConstant": 0,
    "scale": {
        "x": 0.9533333333333333,
        "y": 0.9533333333333334
    },
    "pos": {
        "x": 386.6666666666667,
        "y": 0
...
var SceletonBehaviour = exports.SceletonBehaviour = function () {
    function SceletonBehaviour() {
        _classCallCheck(this, SceletonBehaviour);
    }

    SceletonBehaviour.prototype.onCreate = function onCreate() {};

    SceletonBehaviour.prototype.onUpdate = function onUpdate() {};

    SceletonBehaviour.prototype.onDestroy = function onDestroy() {};

    return SceletonBehaviour;
}();
...
var HelicopterHeadBehaviour = exports.HelicopterHeadBehaviour = function () {
    ...
    HelicopterHeadBehaviour.prototype.onCreate = function onCreate() {};

    HelicopterHeadBehaviour.prototype.onUpdate = function onUpdate() {};

    HelicopterHeadBehaviour.prototype.onDestroy = function onDestroy() {};
...
var _helicopterHead = __webpack_require__(54);
...
var _mainScene = __webpack_require__(53);
...
var _sceleton = __webpack_require__(52);

Object.defineProperty(exports, 'SceletonBehaviour', {
  enumerable: true,
  get: function get() {
    return _sceleton.SceletonBehaviour;
  }
});
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var allUIClasses = __webpack_require__(36);
var absoluteLayout_1 = __webpack_require__(33);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var abstractLight_1 = __webpack_require__(42);
...
var tslib_1 = __webpack_require__(0);
var baseModel_1 = __webpack_require__(5);
var loadingQueue_1 = __webpack_require__(63);
var tileMap_1 = __webpack_require__(28);
var layer_1 = __webpack_require__(27);
var ambientLight_1 = __webpack_require__(62);
var color_1 = __webpack_require__(19);
...
var Scene = /** @class */ (function (_super) {
    ...
    Scene.prototype.getAllGameObjects = function () {
        ...
        for (var i = 0; i < this.layers.length; i++) {
            ...
            for (var j = 0; j < layer.gameObjects.length; j++) {
                var go = layer.gameObjects[layer.gameObjects.length - ONE - j];
                res.push(go);
            }
        }
        return res;
    ...
    Scene.prototype.addGameObject = function (go) {
        this.getDefaultLayer().addGameObject(go);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var move2Dir_1 = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var move4Dir_1 = __webpack_require__(69);
var Parameters = /** @class */ (function () {
    function Parameters() {
        this.velocity = 100;
        this.walkLeftAnimation = 'left';
...
var Control4Dir = /** @class */ (function (_super) {
    ...
    Control4Dir.prototype.onUpdate = function () {
        ...
        if (keyboard.isPressed(keyboard.KEY.UP) || keyboard.isPressed(keyboard.KEY.GAME_PAD_AXIS_UP)) {
            go.rigidBody.velocity.y = -parameters.velocity; // todo interface parameters
            this.go('Up');
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var draggable_1 = __webpack_require__(71);
exports.Draggable = draggable_1.DraggableBehaviour;
var control4Dir_1 = __webpack_require__(70);
...
var commonBehaviours = __webpack_require__(72);
var global_1 = __webpack_require__(7);
var noop = function () { };
...
var scene_1 = __webpack_require__(64);
exports.Scene = scene_1.Scene;
var sound_1 = __webpack_require__(61);
exports.Sound = sound_1.Sound;
var font_1 = __webpack_require__(60);
...
Object.defineProperty(exports, "__esModule", { value: true });
var models = __webpack_require__(76);
...
var Rectangle = /** @class */ (function () {
    function Rectangle(game) {
        this.filters = [];
        this.blendMode = '';
        this.drawingRect = new rect_1.Rect();
        this.game = game;
    }
    ...
    Rectangle.prototype.draw = function () {
        this.game.renderer.fillRect(this.drawingRect, color_1.Color.RGB(12, 222, 100));
    };
    return Rectangle;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var textField_1 = __webpack_require__(17);
var device_1 = __webpack_require__(78);
var size_1 = __webpack_require__(18);
...
var AbstractCanvasRenderer = /** @class */ (function (_super) {
    ...
    function AbstractCanvasRenderer(game) {
        ...
        console.trace('created element', container, _this);
...
Object.defineProperty(exports, "__esModule", { value: true });
var shaderProgram_1 = __webpack_require__(2);
var spriteRectDrawer_1 = __webpack_require__(20);
var mat4 = __webpack_require__(9);
var texShaderGenerator_1 = __webpack_require__(11);
...
var texShaderGenerator_1 = __webpack_require__(11);
var shaderProgram_1 = __webpack_require__(2);
var simpleCopyFilter_1 = __webpack_require__(85);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var abstractBlendDrawer_1 = __webpack_require__(86);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var circle_1 = __webpack_require__(89);
var shaderProgram_1 = __webpack_require__(2);
var abstractDrawer_1 = __webpack_require__(8);
var bufferInfo_1 = __webpack_require__(12);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var line_1 = __webpack_require__(91);
var shaderProgram_1 = __webpack_require__(2);
var bufferInfo_1 = __webpack_require__(12);
var abstractDrawer_1 = __webpack_require__(8);
var colorShaderGenerator_1 = __webpack_require__(22);
...
var shaderProgram_1 = __webpack_require__(2);
var shaderProgramUtils_1 = __webpack_require__(4);
var lightArray_1 = __webpack_require__(44);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var spriteRectLightDrawer_1 = __webpack_require__(98);
var spriteRectDrawer_1 = __webpack_require__(20);
var tiledSpriteRectDrawer_1 = __webpack_require__(94);
var colorRectDrawer_1 = __webpack_require__(93);
var abstractDrawer_1 = __webpack_require__(8);
var lineDrawer_1 = __webpack_require__(92);
var circleDrawer_1 = __webpack_require__(90);
var frameBuffer_1 = __webpack_require__(41);
var matrixStack_1 = __webpack_require__(88);
var mat4 = __webpack_require__(9);
var matEx = __webpack_require__(6);
var texture_1 = __webpack_require__(40);
var addBlendDrawer_1 = __webpack_require__(87);
var rect_1 = __webpack_require__(1);
var abstractCanvasRenderer_1 = __webpack_require__(83);
var shaderMaterial_1 = __webpack_require__(31);
var size_1 = __webpack_require__(18);
...
var webGlRenderer_1 = __webpack_require__(99);
...
var baseAbstractBehaviour_1 = __webpack_require__(25);
var rendererFactory_1 = __webpack_require__(100);
var repository_1 = __webpack_require__(77);
var mouse_1 = __webpack_require__(39);
var keyboard_1 = __webpack_require__(59);
...
var point2d_1 = __webpack_require__(3);
var lightArray_1 = __webpack_require__(44);
var uiBuilder_1 = __webpack_require__(57);
...
var Game = /** @class */ (function (_super) {
    ...
    Game.prototype.runScene = function (scene) {
        ...
        if (true) {
            var allScripts_1 = __webpack_require__(55);
            ...
            scene.layers.forEach(function (l) {
                l.gameObjects.forEach(function (go) {
                    ...
                    if (bhClass && !go.getIndividualBehaviour())
...
Object.defineProperty(exports, "__esModule", { value: true });
var game_1 = __webpack_require__(102);
var gameProps_1 = __webpack_require__(51);
