...
models.Layer = models.BaseModel.extend({
    ...
    construct: function() {
        ...
        this.gameObjectProps.forEach(function(prop){
            ...
            switch (prop.subType) {
                case 'textField':
                    objCloned = new models.TextField(prop);
                    break;
                default:
...
models.Scene = models.BaseModel.extend({
    ...
    construct: function(){
        ...
        this.layerProps.forEach(function(prop){
            ...
            var lCloned = l.clone(models.Layer);
...
models.TextField = models.BaseGameObject.extend({
        ...
        setFont: function(font){
            ...
            this._spriteSheet = new models.SpriteSheet({resourcePath:this._font.resourcePath});
