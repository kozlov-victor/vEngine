...
},{"./alertDialog.html":1,"components/modal/modal":16,"providers/abstractDialog":73,"providers/i18n":77}],3:[function(require,module,exports){
...
},{"./colorPickerDialog.html":9,"components/modal/modal":16,"providers/abstractDialog":73,"providers/i18n":77,"providers/utils":83}],11:[function(require,module,exports){
...
},{"./confirmDialog.html":11,"components/modal/modal":16,"providers/abstractDialog":73,"providers/i18n":77}],13:[function(require,module,exports){
...
},{"./scene.html":17,"providers/editData":75,"providers/i18n":77,"providers/utils":83}],19:[function(require,module,exports){
...
},{"./scriptEditor.html":19,"providers/editData":75,"providers/i18n":77,"providers/resource":78}],21:[function(require,module,exports){
    ...
    methods: {
        ...
        createOrEditCommonBehaviour: function createOrEditCommonBehaviour() {
            ...
            if (!self.editData.currCommonBehaviourInEdit._edited) {
                ...
                self.editData.currGameObjectInEdit.commonBehaviour[currentCbInGoIndex] = self.editData.currCommonBehaviourInEdit.toJSON();
            }
            resource.createOrEditResource(self.editData.currGameObjectInEdit.toJSON(), GameObject, self.editData.gameObjectList, function () {
                self.editData.currGameObjectInEdit = self.editData.gameObjectList.find({ id: self.editData.currGameObjectInEdit.id }).clone();
                self.close();
            });
        }
    }
...
},{"./commonBehaviourDialog.html":21,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83,"providers/validator":84}],23:[function(require,module,exports){
...
module.exports.component = Vue.component('app-font-dialog', {
    ...
    methods: {
        ...
        createOrEditFont: function createOrEditFont(fnt) {
            var self = this;
            ...
            resource.createOrEditResource(fnt, Font, editData.fontList, function (result) {
                self.close();
            });
        }
    }
...
},{"./fontDialog.html":25,"components/colorPicker/colorPicker":8,"providers/abstractDialog":73,"providers/chrome":74,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83,"providers/validator":84}],27:[function(require,module,exports){
...
module.exports.component = Vue.component('app-frame-animation-dialog', {
    ...
    methods: {
        ...
        createOrEditFrameAnimation: function createOrEditFrameAnimation() {
            ...
            resource.createOrEditResource(self.editData.currFrameAnimationInEdit.toJSON(), FrameAnimation, self.editData.frameAnimationList, function (res) {
...
module.exports.component = Vue.component('app-game-object-dialog', {
    ...
    methods: {
        ...
        createOrEditGameObject: function createOrEditGameObject(g) {
            var self = this;
            var model = g.toJSON();
            restResource.save(model).then(function (resp) {
                if (resp.created) {
                    g.id = resp.id;
        ...
        deleteFrameAnimation: function deleteFrameAnimation(fa) {
            ...
            window.confirmEx(this.i18n.confirmQuestion, function () {
                ...
                resource.createOrEditResource(origGameObj.toJSON(), GameObject, self.editData.gameObjectList);
            });
        },

        createCommonBehaviour: function createCommonBehaviour(name) {
            this.editData.currCommonBehaviourInEdit = this.editData.commonBehaviourList.find({ name: name }).clone();
        ...
        deleteCommonBehaviour: function deleteCommonBehaviour(cb) {
            ...
            window.confirmEx(this.i18n.confirmQuestion, function () {
                ...
                self.editData.currGameObjectInEdit.commonBehaviour.remove(self.editData.currGameObjectInEdit.commonBehaviour[currentCbInGoIndex]);
                resource.createOrEditResource(self.editData.currGameObjectInEdit.toJSON(), GameObject, self.editData.gameObjectList, function () {
                    self.editData.currGameObjectInEdit = self.editData.gameObjectList.find({ id: self.editData.currGameObjectInEdit.id }).clone();
                });
            });
...
},{"../../dialogs/commonBehaviourDialog/commonBehaviourDialog":22,"../../dialogs/frameAnimationDialog/frameAnimationDialog":28,"./gameObjectDialog.html":29,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/rest/resource":81,"providers/utils":83,"providers/validator":84}],31:[function(require,module,exports){
...
},{"./layerDialog.html":31,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/validator":84}],33:[function(require,module,exports){
...
module.exports.component = Vue.component('app-particle-system-dialog', {
    ...
    methods: {
        ...
        onGameObjectIdChanged: function onGameObjectIdChanged(id) {
            editData.currParticleSystemInEdit._gameObject = editData.gameObjectList.find({ id: id });
        },
        showPreview: function showPreview() {
            require('../particleSystemPreviewDialog/particleSystemPreviewDialog').instance.open();
        },
        createOrEditPs: function createOrEditPs(ps) {
            var self = this;
            resource.createOrEditResource(ps, ParticleSystem, editData.particleSystemList, function (result) {
                self.close();
            });
        }
    }
...
},{"../particleSystemPreviewDialog/particleSystemPreviewDialog":36,"./particleSystemDialog.html":33,"components/anglePicker/anglePicker":4,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83,"providers/validator":84}],35:[function(require,module,exports){
...
},{"./particleSystemPreviewDialog.html":35,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83}],37:[function(require,module,exports){
...
},{"./sceneDialog.html":37,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/validator":84}],39:[function(require,module,exports){
...
module.exports.component = Vue.component('app-sound-dialog', {
    ...
    methods: {
        ...
        createOrEditSound: function createOrEditSound(sound) {
            var model = sound.toJSON();
            model._file = this._file;
            this._file = '';
            var self = this;
            resource.createOrEditResource(model, Sound, editData.soundList, function (result) {
                self.close();
            });
        }
    }
...
},{"./soundDialog.html":39,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/validator":84}],41:[function(require,module,exports){
...
module.exports.component = Vue.component('app-sprite-sheet-dialog', {
    ...
    methods: {
        ...
        createOrEditSpriteSheet: function createOrEditSpriteSheet(sprSh) {
            var self = this;
            Promise.resolve().then(function () {
                if (self._file) {
                    return restFileSystem.uploadFile(self._file, {});
...
},{"./spriteSheetDialog.html":41,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/rest/fileSystem":79,"providers/rest/resource":81,"providers/utils":83,"providers/validator":84}],43:[function(require,module,exports){
...
},{"./gameObjectRow.html":45,"providers/utils":83}],47:[function(require,module,exports){
...
module.exports = Vue.component('app-fonts', {
    ...
    methods: {
        ...
        deleteFont: function deleteFont(fnt) {
            window.confirmEx(this.i18n.confirmQuestion, function () {
...
},{"../../dialogs/fontDialog/fontDialog":26,"./fonts.html":47,"providers/editData":75,"providers/i18n":77,"providers/resource":78}],49:[function(require,module,exports){
...
module.exports = Vue.component('app-game-objects', {
    ...
    methods: {
        ...
        deleteGameObject: function deleteGameObject(g) {
            window.confirmEx(this.i18n.confirmQuestion, function () {
...
},{"../../dialogs/gameObjectDialog/gameObjectDialog":30,"../_gameObjectRow/gameObjectRow":46,"./gameObjects.html":49,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83}],51:[function(require,module,exports){
...
},{"./gameProps.html":51,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/validator":84}],53:[function(require,module,exports){
...
module.exports = Vue.component('app-particle-systems', {
    ...
    methods: {
        ...
        deleteParticleSystem: function deleteParticleSystem(ps) {
            window.confirmEx(this.i18n.confirmQuestion, function () {
...
},{"../../dialogs/particleSystemDialog/particleSystemDialog":34,"./particleSystems.html":53,"providers/editData":75,"providers/i18n":77,"providers/resource":78}],55:[function(require,module,exports){
...
},{"../../dialogs/layerDialog/layerDialog":32,"../../dialogs/sceneDialog/sceneDialog":38,"../_gameObjectRow/gameObjectRow":46,"./scenes.html":55,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83}],57:[function(require,module,exports){
...
},{"../../dialogs/soundDialog/soundDialog":40,"./sounds.html":57,"providers/editData":75,"providers/i18n":77,"providers/resource":78}],59:[function(require,module,exports){
...
module.exports = Vue.component('app-sprite-sheets', {
    ...
    methods: {
        ...
        deleteSpriteSheet: function deleteSpriteSheet(sprSh) {
            window.confirmEx(this.i18n.confirmQuestion, function () {
...
},{"../../dialogs/spriteSheetDialog/spriteSheetDialog":42,"./spriteSheets.html":59,"providers/editData":75,"providers/i18n":77,"providers/resource":78}],61:[function(require,module,exports){
...
},{"./userInterface.html":61,"providers/editData":75,"providers/i18n":77}],63:[function(require,module,exports){
...
},{"./sceneGameObject.html":63,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/validator":84}],65:[function(require,module,exports){
...
},{"./scene.html":65,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/utils":83,"providers/validator":84}],67:[function(require,module,exports){
...
},{"./projectDialog.html":69,"providers/abstractDialog":73,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/rest/fileSystem":79,"providers/rest/project":80,"providers/validator":84}],71:[function(require,module,exports){
...
},{"./dialogs/projectDialog/projectDialog":70,"./explorer.html":71,"providers/editData":75,"providers/i18n":77,"providers/resource":78,"providers/rest/fileSystem":79,"providers/rest/project":80}],73:[function(require,module,exports){
"use strict";
...
var execMethod = function execMethod(url, method, params, callBack) {
    if (method == 'get' && params) {
        var tail = Object.keys(params).map(function (item) {
...
var Resource = function Resource() {
    ...
    this.deleteResource = function (idOrObject, type, callBack) {
        var id = (typeof idOrObject === 'undefined' ? 'undefined' : _typeof(idOrObject)) == 'object' ? idOrObject.id : idOrObject;
...
},{"providers/editData":75,"providers/http":76}],79:[function(require,module,exports){
'use strict';
...
},{"providers/editData":75,"providers/http":76}],80:[function(require,module,exports){
'use strict';
...
},{"providers/editData":75,"providers/http":76}],81:[function(require,module,exports){
'use strict';
...
},{"providers/editData":75,"providers/http":76}],82:[function(require,module,exports){
'use strict';
...
},{"components/alertDialog/alertDialog":2,"components/confirmDialog/confirmDialog":12}],83:[function(require,module,exports){
'use strict';
...
var Utils = function () {
    ...
    _createClass(Utils, [{
        ...
        key: 'recalcGameObjectSize',
        value: function recalcGameObjectSize(gameObject) {
            var spriteSheet = editData.spriteSheetList.find({ id: gameObject.spriteSheet.id });
            if (!spriteSheet) return;
...
},{"providers/editData":75,"providers/resource":78}],84:[function(require,module,exports){
"use strict";
...
},{"components/alertDialog/alertDialog":2,"components/confirmDialog/confirmDialog":12,"pages/editor/editor":44,"pages/explorer/explorer":72,"providers/resource":78,"providers/userDefinedFns":82}]},{},[85]);
